...
# ==============================================================
# ==============================================================
# perModelData — Dual-Axis Plots (Final Fixed Version)
# ==============================================================
# ==============================================================
# ==============================================================
...
output_dir = "RQ1Results"
os.makedirs(output_dir, exist_ok=True)
main_df = pd.read_csv("Reports/Final_Evaluation_With_CodeBlue.csv")

# ==============================================================
# === Compute per-model metrics for each item ===
# ==============================================================

for model in models:
    source_exm_col = f"{model}_Source_Org_EXM"

    if source_exm_col not in main_df.columns:
        print(f"⚠️ Missing column: {source_exm_col} — skipping {model}")
        continue

    df_filtered = main_df[main_df[source_exm_col] == True].copy()
    print(f"\n=== {model}: {len(df_filtered)} rows where Source_Org_EXM == True ===")
    ...
    output_path = os.path.join(output_dir, f"{model}_BaselineData_Results_{len(df_filtered)}.csv")
...
input_dir = "RQ1Results"
output_dir = "RQ1Results/plots_dual_axis"
os.makedirs(output_dir, exist_ok=True)
...
# ==============================================================
# === Loop through all CSV files and generate dual-axis plots ===
# ==============================================================
